...
buildTMatrix = {'rr': 1, 'rp': 1, 'rs': 1, 'pr': 1,
                'pp': 1, 'ps': 1, 'sr': 1, 'sp': 1, 'ss': 1}
buildTMatrixL = {'rr': 1, 'rp': 1, 'rs': 1, 'pr': 1,
                 'pp': 1, 'ps': 1, 'sr': 1, 'sp': 1, 'ss': 1}
buildTMatrixT = {'rr': 1, 'rp': 1, 'rs': 1, 'pr': 1,
                 'pp': 1, 'ps': 1, 'sr': 1, 'sp': 1, 'ss': 1}
...
buildTMatrixrpsclsp = {'rr': 1, 'rp': 1, 'rsc': 1, 'rl': 1, 'rsp': 1, 'pr': 1, 'pp': 1, 'psc': 1, 'pl': 1, 'psp': 1, 'scr': 1, 'scp': 1,
                       'scsc': 1, 'scl': 1, 'scsp': 1, 'lr': 1, 'lp': 1, 'lsc': 1, 'll': 1, 'lsp': 1, 'spr': 1, 'spp': 1, 'spsc': 1, 'spl': 1, 'spsp': 1}
buildTMatrixLrpsclsp = {'rr': 1, 'rp': 1, 'rsc': 1, 'rl': 1, 'rsp': 1, 'pr': 1, 'pp': 1, 'psc': 1, 'pl': 1, 'psp': 1, 'scr': 1, 'scp': 1,
                        'scsc': 1, 'scl': 1, 'scsp': 1, 'lr': 1, 'lp': 1, 'lsc': 1, 'll': 1, 'lsp': 1, 'spr': 1, 'spp': 1, 'spsc': 1, 'spl': 1, 'spsp': 1}
buildTMatrixTrpsclsp = {'rr': 1, 'rp': 1, 'rsc': 1, 'rl': 1, 'rsp': 1, 'pr': 1, 'pp': 1, 'psc': 1, 'pl': 1, 'psp': 1, 'scr': 1, 'scp': 1,
                        'scsc': 1, 'scl': 1, 'scsp': 1, 'lr': 1, 'lp': 1, 'lsc': 1, 'll': 1, 'lsp': 1, 'spr': 1, 'spp': 1, 'spsc': 1, 'spl': 1, 'spsp': 1}
...
def bigbang():
  ...
  try:
    choice = int(
        input("0: Rock, 1: Paper, 2: Scissors, 3: Lizard, 4: Spock \n"))
  except ValueError:
    print("you must enter an integer \n")
  ...
  while (continuePlaying):
    ...
    try:
      choice = int(
          input("0: Rock, 1: Paper, 2: Scissors, 3: Lizard, 4: Spock, 7: exit \n"))
    except ValueError:
      print("you must enter an integer \n")
    ...
    if (choice == 7):
      ...
      transMatrix = buildTransitionProbabilitiesrpsclsp(
          prevChoice, choice, result)
      machineChoice = random.randint(1, 100)
...
def buildTransitionMatrixrpsclsp(winlosstwo):
    ...
    if winlosstwo == "Win!":
        rock = buildTMatrixrpsclsp['rr'] + buildTMatrixrpsclsp['rsc'] + \
            buildTMatrixrpsclsp['rp'] + \
            buildTMatrixrpsclsp['rl'] + buildTMatrixrpsclsp['rsp']
        paper = buildTMatrixrpsclsp['pr'] + buildTMatrixrpsclsp['psc'] + \
            buildTMatrixrpsclsp['pp'] + \
            buildTMatrixrpsclsp['pl'] + buildTMatrixrpsclsp['psp']
        scissors = buildTMatrixrpsclsp['scr'] + buildTMatrixrpsclsp['scsc'] + \
            buildTMatrixrpsclsp['scp'] + \
            buildTMatrixrpsclsp['scl'] + buildTMatrixrpsclsp['scsp']
        lizard = buildTMatrixrpsclsp['lr'] + buildTMatrixrpsclsp['lsc'] + \
            buildTMatrixrpsclsp['lp'] + \
            buildTMatrixrpsclsp['ll'] + buildTMatrixrpsclsp['lsp']
        spock = buildTMatrixrpsclsp['spr'] + buildTMatrixrpsclsp['spsc'] + \
            buildTMatrixrpsclsp['spp'] + \
            buildTMatrixrpsclsp['spl'] + buildTMatrixrpsclsp['spsp']
        choi = ['r', 'p', 'sc', 'l', 'sp']
        for row_index, row in enumerate(tMatrixrpsclsp):
            for col_index, item in enumerate(row):
                a = int(buildTMatrixrpsclsp['%s%s' %
                        (choi[row_index], choi[col_index])])
                if (row_index == 0):
                    c = a/rock
                elif (row_index == 1):
                    c = a/paper
        ...
        rock = buildTMatrixTrpsclsp['rr'] + buildTMatrixTrpsclsp['rsc'] + \
            buildTMatrixTrpsclsp['rp'] + \
            buildTMatrixTrpsclsp['rl'] + buildTMatrixTrpsclsp['rsp']
        paper = buildTMatrixTrpsclsp['pr'] + buildTMatrixTrpsclsp['psc'] + \
            buildTMatrixTrpsclsp['pp'] + \
            buildTMatrixTrpsclsp['pl'] + buildTMatrixTrpsclsp['psp']
        scissors = buildTMatrixTrpsclsp['scr'] + buildTMatrixTrpsclsp['scsc'] + \
            buildTMatrixTrpsclsp['scp'] + \
            buildTMatrixTrpsclsp['scl'] + buildTMatrixTrpsclsp['scsp']
        lizard = buildTMatrixTrpsclsp['lr'] + buildTMatrixTrpsclsp['lsc'] + \
            buildTMatrixTrpsclsp['lp'] + \
            buildTMatrixTrpsclsp['ll'] + buildTMatrixTrpsclsp['lsp']
        spock = buildTMatrixTrpsclsp['spr'] + buildTMatrixTrpsclsp['spsc'] + \
            buildTMatrixTrpsclsp['spp'] + \
            buildTMatrixTrpsclsp['spl'] + buildTMatrixTrpsclsp['spsp']
        choi = ['r', 'p', 'sc', 'l', 'sp']
        for row_index, row in enumerate(tMatrixTrpsclsp):
            for col_index, item in enumerate(row):
                a = int(buildTMatrixTrpsclsp['%s%s' %
                        (choi[row_index], choi[col_index])])
                if (row_index == 0):
                    c = a/rock
                elif (row_index == 1):
        ...
        rock = buildTMatrixLrpsclsp['rr'] + buildTMatrixLrpsclsp['rsc'] + \
            buildTMatrixLrpsclsp['rp'] + \
            buildTMatrixLrpsclsp['rl'] + buildTMatrixLrpsclsp['rsp']
        paper = buildTMatrixLrpsclsp['pr'] + buildTMatrixLrpsclsp['psc'] + \
            buildTMatrixLrpsclsp['pp'] + \
            buildTMatrixLrpsclsp['pl'] + buildTMatrixLrpsclsp['psp']
        scissors = buildTMatrixLrpsclsp['scr'] + buildTMatrixLrpsclsp['scsc'] + \
            buildTMatrixLrpsclsp['scp'] + \
            buildTMatrixLrpsclsp['scl'] + buildTMatrixLrpsclsp['scsp']
        lizard = buildTMatrixLrpsclsp['lr'] + buildTMatrixLrpsclsp['lsc'] + \
            buildTMatrixLrpsclsp['lp'] + \
            buildTMatrixLrpsclsp['ll'] + buildTMatrixLrpsclsp['lsp']
        spock = buildTMatrixLrpsclsp['spr'] + buildTMatrixLrpsclsp['spsc'] + \
            buildTMatrixLrpsclsp['spp'] + \
            buildTMatrixLrpsclsp['spl'] + buildTMatrixLrpsclsp['spsp']
        choi = ['r', 'p', 'sc', 'l', 'sp']
        for row_index, row in enumerate(tMatrixLrpsclsp):
            for col_index, item in enumerate(row):
                a = int(buildTMatrixLrpsclsp['%s%s' %
                        (choi[row_index], choi[col_index])])
                if (row_index == 0):
                    c = a/rock
                elif (row_index == 1):
...
def displayOtherModes(mode):
  ...
  modes = ["Easy Mode", "Intermediate Mode",
           "Expert Mode", "Super Hard Mode", "Big Bang Mode"]
  print(HighB)
